...
import net.mouta.algafood.api.assembler.CidadeInputDisassembler;
import net.mouta.algafood.api.assembler.CidadeModelAssembler;
import net.mouta.algafood.api.model.CidadeModel;
...
import net.mouta.algafood.domain.service.CadastroCidadeService;
